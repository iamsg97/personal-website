...
A modern, responsive personal portfolio website built with TanStack Query, React, TypeScript, and ShadcN UI.
...
- 🛠️ Built with TanStack Query for efficient data handling
...
Before committing, the pre-commit hook will run linting and formatting checks on your staged files.
